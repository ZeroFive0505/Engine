...
struct ImGui_ImplSDL2_Data
{
    ...
    bool              UseVulkan;
    PlayGround::Context* engine_context;
...
bool ImGui_ImplSDL2_Init(PlayGround::Context* context)
{
    ImGuiIO& io = ImGui::GetIO();
    ...
    bd->Window = static_cast<SDL_Window*>(context->GetSubModule<PlayGround::Window>()->GetHandleSDL());
    bd->UseVulkan = context->GetSubModule<PlayGround::Renderer>()->GetApiType() == PlayGround::RHI_Api_Type::Vulkan;
    ...
    if (SDL_GetWindowWMInfo(bd->Window, &info))
    ...
    if ((io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) && (io.BackendFlags & ImGuiBackendFlags_PlatformHasViewports))
        ImGui_ImplSDL2_InitPlatformInterface(bd->Window);
...
static void ImGui_ImplSDL2_UpdateMouseCursor()
{
    ...
    PlayGround::Input* input = bd->engine_context->GetSubModule<PlayGround::Input>();
