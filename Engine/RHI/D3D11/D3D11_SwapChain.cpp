...
namespace PlayGround
{
    ...
    {
        ASSERT(m_resource != nullptr && "Can't present, the swapchain has not been initialised");
        ASSERT(m_present_enabled && "Can't present, presenting has been disabled");
        ...
        ASSERT(d3d11_utility::error_check(static_cast<IDXGISwapChain*>(m_resource)->Present(sync_interval, flags)) && "Failed to present");
    }
